...
2. Unzip the dowloaded file and rename the folder to "Tab and Slot"
3. Follow the autodesk [instructions](https://www.autodesk.com/support/technical/article/caas/sfdcarticles/sfdcarticles/How-to-install-an-ADD-IN-and-Script-in-Fusion-360.html) to manually install the add-in
